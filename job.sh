...
python script/run.py -c config/recommender/slurm_cfg.yaml --dataset Yelp18 --epochs 1 --bpe 1000 --gpus "[0]" --ckpt /itet-stor/trachsele/net_scratch/tl4rec/ckpts/Beauty_Games_tuned.pth
