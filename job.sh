...
python script/run.py -c config/recommender/slurm_cfg.yaml --dataset LastFM --epochs 0 --bpe 0 --gpus "[0]" --ckpt /itet-stor/trachsele/net_scratch/tl4rec/ckpts/pretrain/LastFM.pth
